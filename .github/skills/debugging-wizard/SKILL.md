...
argument-hint: '<error message, stack trace, or description of unexpected behavior>'
user-invocable: true
...
- Investigating errors, exceptions, or tracebacks
- Analyzing stack traces to find failure points
- Correlating log entries across services
- Troubleshooting crashes or hangs
- Performing root cause analysis on unexpected behavior
- Any "it's not working" / "why is this broken" investigation
...
https://jeffallan.github.io/claude-skills/skills/quality/debugging-wizard/
